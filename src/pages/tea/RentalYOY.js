  ...
  return (
    <div>
      ...
      <div className="card" style={{ padding: 0 }}>
        <div style={{ padding: '14px 20px 0', fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 600 }}>Annual Summary</div>
      ...
      {data.some(d => Object.keys(d.expCats).length > 0) && (
        <div className="card" style={{ padding: 0, marginTop: 20 }}>
          <div style={{ padding: '14px 20px 0', fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 600 }}>Expense Categories by Year</div>
          <div className="table-wrap">
            <table>
              <thead>
